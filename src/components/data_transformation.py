...
class DataTransformation:
    ...
    def data_transformer(self, df):
        try:
            ...
            df['quantity tons'] = stats.boxcox(df['quantity tons'])
            ...
            # Step 12
            df['duration_days'] = df['duration_days'].astype(str)
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            # Define your target_column_name, numerical_columns, and other data processing steps

            input_feature_train_df = train_df.drop(columns=['selling_price'], axis=1)
            target_feature_train_df = train_df['selling_price']

            input_feature_test_df = test_df.drop(columns=['selling_price'], axis=1)
            target_feature_test_df = test_df['selling_price']
